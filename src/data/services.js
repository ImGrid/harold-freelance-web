export const services = [
...

  {
    ...
    technologies: ['React', 'Node.js', 'Base de datos', 'API de pagos', 'Admin Dashboard'],
...

  {
    ...
    technologies: ['Hosting Management', 'Security Updates', 'Performance Optimization'],
    ...
    examples: [
      ...
      },
      {
        ...
        description: 'Actualizaciones semanales, optimización y reportes detallados'
      }
    ],
    icon: '🔧',
    recurring: true
