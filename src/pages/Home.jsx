    ...
    <PageLayout>
      ...
      <CallToAction
        ...
        primaryCTA={{
          ...
          to: "/contacto",
          className:
            "bg-white text-accent-red hover:bg-gray-100 font-semibold px-8 py-4 rounded-lg transition-colors shadow-md",
        }}
        secondaryCTA={{
          text: "Ver Precios",
          to: "/precios",
          className:
            "border-2 border-white text-white hover:bg-white hover:text-accent-red font-semibold px-8 py-4 rounded-lg transition-all",
        }}
